...
const dictionaries = {
  es: {
    ...
    analyzeUI: {
      ...
      payloadCopy: "Copiar payload",
      payloadCopied: "¡Payload copiado!",
      payloadError: "No se pudo copiar el payload.",
      closeButton: "Cerrar",
  ...
  en: {
    ...
    analyzeUI: {
      ...
      payloadError: "Couldn't copy the payload.",
      closeButton: "Close",
  ...
  payloadCopyLabel: "Copy payload",
  payloadCopiedLabel: "Payload copied!",
  payloadErrorLabel: "Could not copy payload.",
  ...
  payloadCopy: "Payload kopieren",
  payloadCopied: "Payload kopiert!",
  payloadError: "Konnte Payload nicht kopieren.",
