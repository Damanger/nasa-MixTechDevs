...
const BASE_MEMBERS = [
  ...
  { image: '/jovani.webp', title: 'Jovani Gallegos', handle: '@heyjovani', borderColor: '#EF4444', gradient: 'linear-gradient(180deg, #EF4444, #000)', url: 'https://www.instagram.com/heyjovani.ga?igsh=MWNvYzNweWxhMGozeg%3D%3D&utm_source=qr', roleKey: 'uiux' },
  { image: '/axel.webp', title: 'Axel García', handle: '@aisaac-gargon', borderColor: '#F59E0B', gradient: 'linear-gradient(145deg, #F59E0B, #000)', url: 'https://www.linkedin.com/in/aisaac-gargon/', roleKey: 'ds' },
